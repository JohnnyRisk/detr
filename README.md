...
```
python -m torch.distributed.launch --nproc_per_node=1 --use_env main.py --train_labels_path ~/software/detr/jsons/coco_aerial_train.json --val_labels_path ~/software/detr/jsons/coco_aerial_val.json --images_path /data/buildings/AerialImageDataset/images --masks --batch_size 2 --epochs 300 --num_workers 6 --num_queries 10 --num_classes 1
```
